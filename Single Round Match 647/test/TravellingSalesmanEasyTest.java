...
public class TravellingSalesmanEasyTest {
	...
	public void test0() {
		...
		assertEquals(10, new TravellingSalesmanEasy().getMaxProfit(M, profit, city, visit));
	}
	...
	public void test1() {
		...
		assertEquals(15, new TravellingSalesmanEasy().getMaxProfit(M, profit, city, visit));
	}
	...
	public void test2() {
		...
		assertEquals(155, new TravellingSalesmanEasy().getMaxProfit(M, profit, city, visit));
	}
	...
	public void test3() {
		...
		assertEquals(1003, new TravellingSalesmanEasy().getMaxProfit(M, profit, city, visit));
	}
	
	@Test(timeout=2000)
	public void test4() {
		int M = 85;
		int[] profit = new int[] {94,21,99,27,91,1,64,96,32,39,84,71,97,53,73,20,7,13,33,45,5,85,7,87,
...
13,29,15,99,73,72,2,81,39,75,1,54};
		int[] city = new int[] {72,69,19,25,3,65,10,42,37,76,29,34,41,14,46,46,37,55,30,32,84,57,74,
...
49,54,29,17,81,83,13,8,69,5,84};
		int[] visit = new int[] {39,29,15,5,3,65,29,64,60,21,13,10,73,75,44,84,15,61,26,49,31,27,83,24,
...
83,35,56,82,2,14,59,68,74,32,31,3,28,38,54,38};
		assertEquals(4369, new TravellingSalesmanEasy().getMaxProfit(M, profit, city, visit));
	}
}
